...
function buildPrompt(config: Record<string, string>): string {
  return `Sos un experto en CRO (Conversion Rate Optimization) especializado en páginas de venta para dropshipping COD en ${cfg?.nombre || 'Paraguay'}. Analizás páginas de destino con ojo quirúrgico.
...
4. Social proof: testimonios, cantidad de compradores, stars — crítico en ${cfg?.nombre || 'Paraguay'} por la desconfianza
