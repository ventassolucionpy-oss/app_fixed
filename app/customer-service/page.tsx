...
- Estar en el español/modalismo de ${config.pais || pais || 'PY'}
            ...
            <div className="card p-5 space-y-4">
              <div className="grid grid-cols-2 gap-3">
                ...
                <div>
                  ...
                  <select className={`${inputClass} cursor-pointer`} value={config.pais || pais || 'PY'} onChange={e => setConfig(p => ({ ...p, pais: e.target.value }))} style={{ background: '#111' }}>
