...
Diseñá el sistema completo de retención. Los mensajes deben sonar HUMANOS, no automatizados. En ${pais === 'PY' ? 'Paraguay' : pais === 'CO' ? 'Colombia' : 'México'} el trato cercano y la cercanía funcionan mucho mejor que el formalismo.
          ...
          <div className="space-y-5">
            ...
            <div className="card p-4 border border-emerald-500/20 bg-emerald-500/5">
              ...
              <p className="text-white/50 text-xs leading-relaxed">
                En ${pais || 'Paraguay'} COD, conseguir que un cliente compre por segunda vez cuesta 5x menos que adquirir uno nuevo. Si solo el 15% de tus clientes recompra en 60 días, tu rentabilidad real puede subir 40% sin gastar más en ads.
              </p>
            </div>
