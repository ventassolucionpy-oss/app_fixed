...
PAÍS: ${config.pais || pais || 'Paraguay'}
          ...
          <div className="space-y-5 animate-fade-up">
            ...
            <div className="card p-5 space-y-4">
              <div>
                ...
                <input className={inputClass} value={config.publico||''} onChange={e => setConfig(p => ({...p,publico:e.target.value}))} placeholder={`Ej: Mujeres 18-35 en ${pais || 'Paraguay'}`} />
              </div>
