...
async function callClaude(data: Record<string, string>): Promise<UpsellOutput> {
    const prompt = `Sos un experto en revenue optimization para dropshipping COD en ${paisCfg?.nombre || pais || 'PY'}. Tu especialidad es aumentar el ticket promedio sin reducir la tasa de conversión.
...
- Ticket promedio actual en ${paisCfg?.nombre || pais || 'PY'}: Gs. 80k-250k — el upsell ideal agrega un 30-50% más
...
Diseñá la estrategia completa de upsell y bundle. Respondé SOLO con JSON válido:
{
  ...
  "upsell_principal": {
    ...
    "razon_funciona": "por qué este upsell específicamente funciona en ${paisCfg?.nombre || pais || 'PY'} COD"
  },
  "bundles": [
    {
    ...
    <div className="min-h-screen">
      ...
      <main className="max-w-lg mx-auto px-4 py-6">
        ...
        <div className="card p-3 border border-emerald-500/20 bg-emerald-500/5 mb-5">
          <p className="text-emerald-300 text-xs font-bold mb-1">💡 Por qué importa en COD</p>
