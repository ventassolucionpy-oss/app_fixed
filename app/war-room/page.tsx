...
async function analyzeWarRoom(campaigns: CampaignStatus[], contexto: string): Promise<WarRoomAnalysis> {
  ...
  const prompt = `Sos el Chief Media Buyer de una operación de ecommerce en ${cfg?.nombre || 'Paraguay'} con presupuesto alto en ad spend. Estás en la sala de guerra revisando el estado de TODAS las campañas ahora mismo. Contexto: ${cfg?.contexto_cultural || 'Paraguay, COD, precios en Guaraníes'}. Moneda local: ${cfg?.moneda || 'PYG'}.
        ...
        {step === 'analysis' && analysis && (
          <div className="space-y-4 animate-fade-up">
            ...
            <div className="flex gap-2 pt-1">
              ...
              <div className="mt-6">
          <Link href="/rutina-diaria" className="flex items-center gap-2 text-xs text-violet-400 hover:text-violet-300 transition-colors">
            ⚡ Ver rutina operativa completa →
          </Link>
        </div>
      </main>
    </div>
