...
PRODUCTO: ${product.name} | Descripción: ${product.description} | Precio: ${config.precio || 'no especificado'} | País: ${config.pais || pais || 'PY'} | Tono: ${config.tono || 'Cercano y profesional'}
            ...
            <div className="card p-5 space-y-4">
              <div className="grid grid-cols-2 gap-3">
                ...
                <div>
                  ...
                  <select className={`${ic} cursor-pointer`} value={config.pais || pais || 'PY'} onChange={e => setConfig(p => ({ ...p, pais: e.target.value }))} style={{ background: '#111' }}>
